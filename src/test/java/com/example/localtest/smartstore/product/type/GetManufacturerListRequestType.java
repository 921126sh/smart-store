...
/**
 * <p>GetManufacturerListRequestType complex type에 대한 Java 클래스입니다.
 * 
...
public class GetManufacturerListRequestType
    extends BaseProductRequestType
{

    @XmlElement(name = "ManufacturerName", namespace = "", required = true)
