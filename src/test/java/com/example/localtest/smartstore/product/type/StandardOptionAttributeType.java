...
/**
 * <p>StandardOptionAttributeType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="StandardOptionAttributeType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="AttributeValueRealName" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "StandardOptionAttributeType", propOrder = {
    "attributeId",
    "attributeValueId",
    "attributeValueName",
    "attributeValueRealName",
    "imageUrl"
})
public class StandardOptionAttributeType {
    ...
    @XmlElement(name = "AttributeValueRealName", required = true)
    protected String attributeValueRealName;
    ...
    /**
     * attributeValueRealName 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAttributeValueRealName() {
        return attributeValueRealName;
    }

    /**
     * attributeValueRealName 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAttributeValueRealName(String value) {
        this.attributeValueRealName = value;
    }
