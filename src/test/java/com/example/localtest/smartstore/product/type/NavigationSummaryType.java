...
/**
 * <p>NavigationSummaryType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="NavigationSummaryType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="UpdateCost" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="FreeCostPeriod" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "NavigationSummaryType", propOrder = {
    "itemName",
    "modelName",
    "certified",
    "ratedVoltage",
...
public class NavigationSummaryType
    extends BaseSummaryType
{
    ...
    @XmlElement(name = "UpdateCost", required = true)
    protected String updateCost;
    @XmlElement(name = "FreeCostPeriod", required = true)
    protected String freeCostPeriod;
     ...
     *     
     */
    public void setUpdateCost(String value) {
        this.updateCost = value;
    }

    /**
     * freeCostPeriod 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getFreeCostPeriod() {
        return freeCostPeriod;
    }

    /**
     * freeCostPeriod 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setFreeCostPeriod(String value) {
        this.freeCostPeriod = value;
    }
