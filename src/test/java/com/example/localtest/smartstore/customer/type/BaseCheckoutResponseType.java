 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://customerinquiry.shopn.platform.nhncorp.com/}BaseResponseType">
 *       &lt;sequence>
...
@XmlSeeAlso({
    GetCustomerInquiryListResponseType.class,
    AnswerCustomerInquiryResponseType.class,
    ListResponseType.class
})
public abstract class BaseCheckoutResponseType
