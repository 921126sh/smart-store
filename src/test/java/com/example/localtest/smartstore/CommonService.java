...
public class CommonService {
    ...
    public void 상품주문내역_상세조회() throws Exception {
        ...
        ArrayList<String> x = new ArrayList<String>(){{
            add("PONO400000000003");
        }};

        x.forEach(str -> getProductOrderInfoListRequest.getProductOrderIDList().add(str));
        ...
        if ("SUCCESS".equals(response.getResponseType())) {
            log.info("상품번호 : [" + response.getProductOrderInfoList().toString() + "]");
...
//        getChangedProductOrderListRequest.setLastChangedStatusCode(ProductOrderChangeType.PURCHASE_DECIDED);
        ...
        fromDate.set(2021, Calendar.JANUARY, 05, 02, 01, 01);
