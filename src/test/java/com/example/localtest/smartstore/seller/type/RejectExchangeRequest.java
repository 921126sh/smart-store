...
/**
 * <p>rejectExchangeRequest complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="rejectExchangeRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="RejectDetailContent" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "rejectExchangeRequest", propOrder = {
    "productOrderID",
    "rejectDetailContent"
})
public class RejectExchangeRequest
    extends BaseCheckoutRequestType
{

    @XmlElement(name = "ProductOrderID", required = true)
    protected String productOrderID;
    @XmlElement(name = "RejectDetailContent", required = true)
    protected String rejectDetailContent;
    ...
    /**
     * rejectDetailContent 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * rejectDetailContent 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setRejectDetailContent(String value) {
        this.rejectDetailContent = value;
    }
