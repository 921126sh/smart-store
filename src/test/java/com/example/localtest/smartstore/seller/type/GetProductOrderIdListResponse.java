...
/**
 * <p>getProductOrderIdListResponse complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="getProductOrderIdListResponse">
 *   &lt;complexContent>
 *     &lt;extension base="{http://seller.shopn.platform.nhncorp.com/}BaseCheckoutResponseType">
 *       &lt;sequence>
 *         &lt;element name="ProductOrderIDList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "getProductOrderIdListResponse", propOrder = {
    "productOrderIDList"
})
public class GetProductOrderIdListResponse
    extends BaseCheckoutResponseType
{

    @XmlElement(name = "ProductOrderIDList")
