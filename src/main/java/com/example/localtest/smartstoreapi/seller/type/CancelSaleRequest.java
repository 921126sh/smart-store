...
/**
 * <p>cancelSaleRequest complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="cancelSaleRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="CancelReasonCode" type="{http://seller.shopn.platform.nhncorp.com/}claimRequestReasonType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "cancelSaleRequest", propOrder = {
    "productOrderID",
    "cancelReasonCode"
})
    ...
    extends BaseCheckoutRequestType
{
    ...
    @XmlElement(name = "CancelReasonCode", required = true)
    @XmlSchemaType(name = "string")
    protected ClaimRequestReasonType cancelReasonCode;
     ...
     *     
     */
    public ClaimRequestReasonType getCancelReasonCode() {
        return cancelReasonCode;
    }

    /**
     * cancelReasonCode 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link ClaimRequestReasonType }
     *     
     */
    public void setCancelReasonCode(ClaimRequestReasonType value) {
