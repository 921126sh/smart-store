...
/**
 * <p>GetModificationRequiredProductListRequestType complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "GetModificationRequiredProductListRequestType", propOrder = {
    "sellerId",
    "page",
    "pageSize"
})
public class GetModificationRequiredProductListRequestType
