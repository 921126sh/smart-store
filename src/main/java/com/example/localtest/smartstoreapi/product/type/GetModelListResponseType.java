...
/**
 * <p>GetModelListResponseType complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ModelList" type="{http://shopn.platform.nhncorp.com/}ModelListType" minOccurs="0"/>
...
public class GetModelListResponseType
    extends BaseProductResponseType
{

    @XmlElement(name = "ModelList", namespace = "")
    protected ModelListType modelList;
     ...
     *     
     */
    public ModelListType getModelList() {
        return modelList;
    }

    /**
     * modelList 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link ModelListType }
     *     
     */
    public void setModelList(ModelListType value) {
