...
/**
 * <p>GetModelListRequestType complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "GetModelListRequestType", propOrder = {
    "modelId",
    "modelName",
    "page"
})
public class GetModelListRequestType
    extends BaseProductRequestType
{

    @XmlElement(name = "ModelId", namespace = "")
